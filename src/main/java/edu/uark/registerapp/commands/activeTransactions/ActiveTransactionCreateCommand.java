...
@Service
public class ActiveTransactionCreateCommand implements ResultCommandInterface<Product> {
	@Override
	...
	public ActiveTransactionCreateCommand setApiProduct(final Product apiProduct) {
