...
@Service
public class ActiveTransactionsUpdateCommand implements ResultCommandInterface<Product> {
	@Transactional
	@Override
	...
	public ActiveTransactionsUpdateCommand setProductId(final UUID productId) {
	...
	public ActiveTransactionsUpdateCommand setApiProduct(final Product apiProduct) {
