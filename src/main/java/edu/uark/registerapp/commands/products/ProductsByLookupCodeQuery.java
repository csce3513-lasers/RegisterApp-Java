...
@Service
public class ProductsByLookupCodeQuery implements ResultCommandInterface<Product> {
	@Override
	...
	public ProductsByLookupCodeQuery setLookupCode(final String lookupCode) {
